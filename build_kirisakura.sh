...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r399163/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r399163/lib64:$LD_LIBRARY_PATH
