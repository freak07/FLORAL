...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r437112b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r437112b/lib64:$LD_LIBRARY_PATH
