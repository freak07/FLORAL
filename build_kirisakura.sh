...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r407598/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r407598/lib64:$LD_LIBRARY_PATH
