...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r450784b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r445002/lib64:$LD_LIBRARY_PATH
