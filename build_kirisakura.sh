...
export CLANG_PATH=~/Android_Build/Clang_Google_Prebuilts/clang-r445002/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google_Prebuilts/clang-r445002/lib64:$LD_LIBRARY_PATH
