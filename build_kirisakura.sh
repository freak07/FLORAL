...
export CLANG_PATH=/media/miles/Storage/CLANG_TC/tc-build/install2/bin
export PATH=${CLANG_PATH}:${PATH}
export DTC_EXT=/home/miles/Downloads/wahoo-kernel-tools/bin/dtc
...
export LD_LIBRARY_PATH=/media/miles/Storage/CLANG_TC/tc-build/install2/lib:$LD_LIBRARY_PATH
