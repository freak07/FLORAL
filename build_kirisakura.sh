...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r383902b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r383902b/lib64:$LD_LIBRARY_PATH
