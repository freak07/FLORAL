...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r416183b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r416183b/lib64:$LD_LIBRARY_PATH
