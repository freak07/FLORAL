...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r475365b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r475365b/lib64:$LD_LIBRARY_PATH
